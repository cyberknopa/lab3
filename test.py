...
class TestMNISTModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.y_train_10 = tf.keras.utils.to_categorical(self.y_train[:num_train_samples], 10)
        self.x_test_10 = self.x_test[:num_test_samples].astype('float32') / 255
        self.y_test_10 = tf.keras.utils.to_categorical(self.y_test[:num_test_samples], 10)
    ...
    def test_model_training(self):
        ...
        history = model.fit(self.x_train_10, self.y_train_10, epochs=1, batch_size=32, validation_data=(self.x_test_10, self.y_test_10))
